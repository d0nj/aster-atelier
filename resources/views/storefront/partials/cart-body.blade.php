                    ...
                    <div class="grid gap-5 sm:grid-cols-[11rem_1fr]">
                        ...
                        <div class="flex flex-col justify-between gap-5">
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <form action="{{ route('cart.update', $item->product) }}" method="POST" class="flex items-center gap-3" data-cart-mutate>
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form action="{{ route('cart.destroy', $item->product) }}" method="POST" data-cart-mutate>
                                    @csrf
                                    @method('DELETE')
